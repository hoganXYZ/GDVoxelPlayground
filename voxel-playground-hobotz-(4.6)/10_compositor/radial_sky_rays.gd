...
func _initialize_compute():
	...
	# Create our shaders
	var shader_file = load("res://10_compositor/make_sun_disk.glsl")
	...
	shader_file = load("res://10_compositor/radial_blur.glsl")
	...
	shader_file = load("res://10_compositor/gaussian_blur.glsl")
	shader_spirv = shader_file.get_spirv()
	...
	shader_file = load("res://10_compositor/overlay.glsl")
	shader_spirv = shader_file.get_spirv()
