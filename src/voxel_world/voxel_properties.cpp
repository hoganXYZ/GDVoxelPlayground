...
{
    shader->add_existing_buffer(element_table, RenderingDevice::UNIFORM_TYPE_STORAGE_BUFFER, 8, 1);
    shader->add_existing_buffer(reaction_rules, RenderingDevice::UNIFORM_TYPE_STORAGE_BUFFER, 9, 1);
